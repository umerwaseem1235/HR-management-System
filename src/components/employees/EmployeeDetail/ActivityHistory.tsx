...
import { mockAssets, mockAttendance, mockLeaveBalances } from '../../../lib/mock-data';
...
export default function ActivityHistory({ activeTab, employee, employeeSlips }: ActivityHistoryProps) {
