...
export default function StatCard({ 
  ...
  return (
    <div className="group relative h-full min-w-0 overflow-hidden rounded-2xl border border-[#D6E4E8]/70 bg-white p-3 xl:p-4 2xl:p-5 shadow-[0_1px_2px_rgba(23,50,77,0.05),0_10px_30px_-14px_rgba(23,50,77,0.18)] card-hover">
      ...
      <div className="relative flex items-start justify-between gap-2 xl:gap-3">
        <div className="min-w-0 flex-1">
          <p className="truncate whitespace-nowrap text-[10px] xl:text-xs font-medium text-gray-500 tracking-wide uppercase" title={title}>{title}</p>
        ...
        <div className={`${bgClass} relative shrink-0 rounded-xl xl:rounded-2xl p-2 xl:p-2.5 shadow-md ring-1 ring-black/5 group-hover:scale-105 group-hover:-rotate-2 transition-transform duration-300 ease-in-out`}>
