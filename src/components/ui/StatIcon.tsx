...
export type StatIconName = keyof typeof premiumIcons;

// Per-metric theme: vibrant stroke color + soft tinted gradient tile
export const iconThemes: Record<StatIconName, { color: string; bg: string }> = {
...
export function PremiumIcon({ name, size = 18, color }: { name: StatIconName; size?: number; color?: string }) {
