...
import { createRun, runToPayslips, DEFAULT_COMPONENTS } from './payroll';
...
export const mockLeaveRequests: LeaveRequest[] = [
  ...
  { id: '2', employeeId: '1', employeeName: 'Michael Chen', leaveType: 'Monthly Leave', startDate: '2024-01-15', endDate: '2024-01-16', days: 2, reason: 'Not feeling well', status: 'Pending', appliedOn: '2024-01-08' },
  { id: '3', employeeId: '4', employeeName: 'Emily Rodriguez', leaveType: 'Monthly Leave', startDate: '2024-01-22', endDate: '2024-01-22', days: 1, reason: 'Personal appointment', status: 'Pending', appliedOn: '2024-01-08' },
  ...
  { id: '5', employeeId: '6', employeeName: 'Priya Sharma', leaveType: 'Monthly Leave', startDate: '2024-01-03', endDate: '2024-01-03', days: 1, reason: 'Medical checkup', status: 'Approved', appliedOn: '2024-01-02', approvedBy: 'Sarah Williams' },
...
export const mockLeaveBalances: LeaveBalance[] = [
  { leaveType: 'Monthly Leave', total: 2, used: 1, remaining: 1, pending: 2 },
  { leaveType: 'Annual Leave', total: 20, used: 8, remaining: 12, pending: 4 },
  { leaveType: 'Maternity Leave', total: 90, used: 0, remaining: 90, pending: 0 },
  { leaveType: 'Paternity Leave', total: 15, used: 0, remaining: 15, pending: 0 },
];

// December 2023 payslips for the rest of the company, generated by the payroll
// engine (same math live runs use: basic = annual ÷ 12 + default structure).
// Michael Chen's December slip below is kept as-is (id '1') so existing
// references stay stable; the seed run picks up all December slips.
const seedDec2023Run = createRun(
  11, 2023,
  mockEmployees.filter(e => e.id !== '1'),
  DEFAULT_COMPONENTS, mockLeaveRequests, mockAttendance, '2023-12-28',
);
const seedDec2023Payslips: Payslip[] = runToPayslips(
  { ...seedDec2023Run, status: 'Finalized', finalizedOn: '2024-01-01', finalizedBy: 'Sarah Williams' },
  '2024-01-01',
);
