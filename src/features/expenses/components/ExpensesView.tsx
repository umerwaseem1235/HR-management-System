            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                {e.viewingReceipt && (
                  <div className="flex items-center gap-2">
                    <button type="button" title="Zoom out" onClick={e.zoomOut} disabled={e.zoom <= 0.1} className="p-1.5 rounded-lg bg-[#EAF2F4] text-[#17324D] hover:bg-[#D6E4E8] disabled:opacity-40 disabled:cursor-not-allowed"><ZoomOut size={14} /></button>
                    ...
                    <button type="button" title="Reset zoom" onClick={() => e.setZoom(0.5)} className="p-1.5 rounded-lg bg-[#EAF2F4] text-[#17324D] hover:bg-[#D6E4E8]"><RotateCcw size={14} /></button>
                  </div>
                )}
              </div>
              <div className="overflow-auto max-h-[55vh] rounded-xl border border-[#D6E4E8] bg-[#EAF2F4]/40 min-h-[180px] flex items-center justify-center">
                {e.viewingReceipt?.startsWith('data:application/pdf') ? (
                  <iframe src={e.viewingReceipt} title="Receipt" className="w-full h-[55vh] origin-top" style={{ transform: `scale(${e.zoom})` }} />
                ) : e.viewingReceipt ? (
                  <img src={e.viewingReceipt} alt="Expense receipt" className="block mx-auto max-w-none origin-top" style={{ transform: `scale(${e.zoom})` }} />
                ) : (
